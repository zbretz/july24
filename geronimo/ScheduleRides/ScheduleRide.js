...
import ScheduleAirport from './ScheduleAirport1';
    ...
    return (
        ...
        >
            ...
            <Stack.Screen name="Airport">
                {props => <ScheduleAirport {...props} masterState={masterState} setMasterState={setMasterState} setDestination={setDestination} setPickupLocation={setPickupLocation} date={date} setDate={setDate} flightNumber={flightNumber} />}
            </Stack.Screen>
